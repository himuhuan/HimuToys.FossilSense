...
use tower_lsp::lsp_types::{
    CompletionItem, CompletionList, CompletionResponse, Documentation, Position, Url,
};
...
mod presentation;
use presentation::{
    lsp_kind_for_member, member_detail, member_documentation, member_kind_rank, remember_member,
...
mod tests {
    use super::*;
    use crate::parser::MemberConfidence;
