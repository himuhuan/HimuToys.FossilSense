...
pub struct IndexStatus {
    ...
    /// Compatibility wire field: contains the canonical declaration count.
    pub symbols: usize,
    pub callable_anchors: usize,
    ...
    pub secondary_index_ms: u128,
    pub publication_ms: u128,
...
impl IndexStatus {
    pub fn indexing_phase(workspace: String, stats: &IndexStats, phase: impl Into<String>) -> Self {
        Self {
            ...
            symbols: stats.declarations,
            callable_anchors: stats.callable_anchors,
            ...
            secondary_index_ms: stats.secondary_index_ms,
            publication_ms: stats.publication_ms,
