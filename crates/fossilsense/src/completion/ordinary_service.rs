...
mod fallback_table;
use fallback_table::fallback_matches;
pub(crate) use fallback_table::{FallbackCompletionName, FallbackCompletionNameTable};
...
mod tests {
    ...
    use super::{
        complete_ordinary_identifier, FallbackCompletionName, FallbackCompletionNameTable,
        OrdinaryCompletionDocumentationTarget, OrdinaryCompletionInput, OrdinaryCompletionKind,
        OrdinaryCompletionNameTable, PRIMARY_COMPLETION_SUFFICIENCY,
    };
